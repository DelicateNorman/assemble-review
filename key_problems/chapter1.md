...
## 目录
1. [1.14 简述PC的最低1MB主存空间的使用情况](#114-简述pc的最低1mb主存空间的使用情况)
2. [1.17 指令指针寄存器IP的作用是什么？](#117-指令指针寄存器ip的作用是什么)
3. [1.18 字和双字在存储器中如何存放，什么是"小端方式"？对字和双字存储单元，什么是它们的对齐地址？为什么要对齐地址？](#118-字和双字在存储器中如何存放什么是小端方式对字和双字存储单元什么是它们的对齐地址为什么要对齐地址)
4. [1.19 什么是8086中的逻辑地址和物理地址？逻辑地址如何转换成物理地址？请将如下逻辑地址用物理地址表达（表达地址默认采用十六进制数）：](#119-什么是8086中的逻辑地址和物理地址逻辑地址如何转换成物理地址请将如下逻辑地址用物理地址表达表达地址默认采用十六进制数)
5. [1.20 8086有哪4种逻辑段？各种逻辑段分别是什么用途？](#120-8086有哪4种逻辑段各种逻辑段分别是什么用途)
6. [1.24 说明下列指令中源操作数的寻址方式？如果BX = 2000H，DI = 40H，给出DX的值或有效地址EA的值。](#124-说明下列指令中源操作数的寻址方式如果bx--2000h-di--40h给出dx的值或有效地址ea的值)
